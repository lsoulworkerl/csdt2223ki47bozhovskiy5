...
import pygame_menu
from classic import tetris_classic
from table import table
from tetris_ai import bot
...
def pVSp(TILE, W, H, clock, FPS, screen, bot_user, menu):
...
def main():
    ...
    TILE = 45
    FPS = 60
    menu = pygame_menu.Menu('Welcome', 400, 410)
    table_menu = pygame_menu.Menu('Top 10', 400, 600)
    menu.add.button('Classic tetris', tetris_classic, TILE, W, H, clock, FPS, screen, menu)
    menu.add.button('player vs bot', pVSp, TILE, W, H, clock, FPS, screen, 1, menu)
    menu.add.button('player vs player', pVSp, TILE, W, H, clock, FPS, screen, 0, menu)
    menu.add.button('bot vs bot', bot, TILE, W, H, clock, FPS, screen, 1, menu)
    menu.add.button('top 10', table, table_menu, screen, menu)
